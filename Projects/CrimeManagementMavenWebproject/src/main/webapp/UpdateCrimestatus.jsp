...
<td><%=resultSet.getString("informer") %></td>
<td><%=resultSet.getString("suspectdetails") %></td>
...
<input type="text" name="crimeid" id="crimeid" required><br><br>
<label for="criminalid">Criminal Id:</label>
<input type="text" name="criminalid" id="criminalid" required><br><br>
<label>Date:</label>
<input type="date"  id="date" name="date"><br><br>
<label>Punishment:</label>
<input type="text"  id="punishment" name="punishment"><br><br>
